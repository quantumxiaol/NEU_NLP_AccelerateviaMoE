...
# 束搜索
def beamSearch(model, enc_id2vocab, enc_vocab2id, dec_id2vocab, dec_vocab2id, source_sentence, k: int, expertModule, expertList):
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for line in test_s[:test_size]:
            ...
            search_sources, search_result = beamSearch(model, enc_id2vocab, enc_vocab2id, dec_id2vocab, dec_vocab2id,enc_input, k, expertModule, expertList)
